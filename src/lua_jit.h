...
static LJ_AINLINE void setintV(TValue * o, int32_t
i)
{
#if LJ_DUALNUM
...
static LJ_AINLINE void setint64V(TValue * o, int64_t
i)
{
...
static LJ_AINLINE int32_t
lj_num2bit(lua_Number
n)
{
#if LJ_SOFTFP
...
TValue o;
o.
n = n + 6755399441055744.0;  /* 2^52 + 2^51 */
return (int32_t)o.u32.
lo;
#endif
}
